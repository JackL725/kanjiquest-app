...
// 327 entries: each primitive has a character (standard Unicode or PUA),
...
const PRIMITIVES = [
  ...
  // ── Kanji as Primitives (alternate mnemonic names) ──
  // These kanji have special alternate names when used as building blocks.
  // Standard kanji font (not PUA).
  ...
  { id: 'ka-needle', char: '博', name: 'needle', strokes: 12, page: 48, pua: false },
  { id: 'ka-shells', char: '貝', name: 'shells', strokes: 7, page: 56, pua: false },
  { id: 'ka-head', char: '頁', name: 'head', strokes: 9, page: 64, pua: false },
  { id: 'ka-fishhook', char: '乙', name: 'fishhook', strokes: 1, page: 75, pua: false },
  ...
  { id: 'ka-ball', char: '玉', name: 'ball', strokes: 5, page: 272, pua: false },
  ...
  { id: 'ka-eel', char: '亀', name: 'eel', strokes: 11, page: 573, pua: false },
  ...
  { id: 'ka-shakuhachi', char: '尺', name: 'shakuhachi', strokes: 4, page: 1151, pua: false },
  ...
  { id: 'ka-strung-together', char: '共', name: 'strung together', strokes: 6, page: 1934, pua: false },
  ...
  { id: 'ka-human-legs', char: '虎', name: 'human legs', strokes: 8, page: 2145, pua: false },
  { id: 'ka-tiger', char: '鹿', name: 'tiger', strokes: 11, page: 2154, pua: false },
]
