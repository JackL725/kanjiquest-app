...
// Primitives first (building blocks), then Kanji 101, then game decks
export const ALL_DECKS = [primitives, primer, p5r, zeldaAlttp, chronoTrigger, ninoKuni, ff6, pokemonFr, yotsuba, yokaiWatch1]

// Free decks owned by everyone; content decks also owned for dev/testing (will come from Supabase later)
export const OWNED_DECK_IDS = ['primitives', 'primer', 'p5r', 'zelda-alttp', 'chrono-trigger', 'ni-no-kuni', 'ff6', 'pokemon-fr', 'yotsuba', 'yokai-watch-1']
