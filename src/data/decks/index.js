...
export const ALL_DECKS = [radicals, primer, p5r, zeldaAlttp, chronoTrigger, yotsuba]

// Free decks owned by everyone; content decks also owned for dev/testing (will come from Supabase later)
export const OWNED_DECK_IDS = ['radicals', 'primer', 'p5r', 'zelda-alttp', 'chrono-trigger', 'yotsuba']
